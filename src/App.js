      ...
      <div className="container services-container">
        <div className="row">
          ...
          <div className="col-md">
            <h2>Events</h2>
            <p>
              Join our women-only events and activities to meet other
              like-minded women just like you. Maybe you'll meet a future travel
              buddy or make a friend for life in Japan.
            </p>
          </div>
          <div className="col-md">
            <h2>Accommodation</h2>
